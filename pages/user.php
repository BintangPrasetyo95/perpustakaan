  ...
  <div class="col-12">
    <div class="card mb-4">
      <div class="card-header pb-0">
        ...
        <span class="badge btn btn-sm bg-gradient-success ms-0" data-bs-toggle="modal" data-bs-target="#tambah">+ Tambah User</span>
      </div>
          ...
          <table class="table align-items-center mb-0 table-hover">
            ...
            <tbody>
              ...
              if (isset($_POST['caridata'])) {
                ...
                $query = query("SELECT * FROM user WHERE username LIKE '%$cari%' OR email LIKE '%$cari%' OR nama_lengkap LIKE '%$cari%' OR alamat LIKE '%$cari%' AND role='tamu' ORDER BY nama_lengkap ");
              }else {
                $query = query("SELECT * FROM user WHERE role='tamu' ORDER BY nama_lengkap ");
              }
      ...
      <form method="post">
        <div class="modal-body">
          ...
          <div class="row">
            <div class="mb-3">
              <label class="form-label text-xs font-weight-bold mb-0">Password :</label>
              <input type="password" title="Masukkan Password" name="pw" maxlength="32" onkeypress="return event.which != 32" class="form-control" maxlength="40" placeholder="Masukkan Password" required>
            </div>
          </div>
          <div class="row">
            <div class="mb-3">
              <label class="form-label text-xs font-weight-bold mb-0">Konfirmasi Password :</label>
              <input type="password" title="Konfirmasi Password" name="pw_konf" maxlength="32" onkeypress="return event.which != 32" class="form-control" maxlength="40" placeholder="Konfirmasi Password" required>
            </div>
          </div>
        </div>
        <div class="modal-footer">
